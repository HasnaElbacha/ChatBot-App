...
import com.errami.chatbot.adapters.ChatBotAdapter;
import com.errami.chatbot.apis.BrainShopApi;
import com.errami.chatbot.models.BrainShopResponse;
import com.errami.chatbot.models.MessageModel;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonSend.setOnClickListener(view -> {
           ...
           String url = "http://api.brainshop.ai/get?bid=181522&key=VyZzIkw1rP2v1U22&uid=[uid]&msg=" + msg;
